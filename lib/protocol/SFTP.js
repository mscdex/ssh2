...
const STATUS_CODE_STR = {
  ...
  [STATUS_CODE.INVALID_HANDLE]: 'Invalid handle',
  [STATUS_CODE.NO_SUCH_PATH]: 'No such path',
  [STATUS_CODE.FILE_ALREADY_EXISTS]: 'File already exists',
  [STATUS_CODE.WRITE_PROTECT]: 'Write protect',
  [STATUS_CODE.NO_MEDIA]: 'No media',
  [STATUS_CODE.NO_SPACE_ON_FILESYSTEM]: 'No space on filesystem',
  [STATUS_CODE.QUOTA_EXCEEDED]: 'Quota exceeded',
  [STATUS_CODE.UNKNOWN_PRINCIPAL]: 'Unknown principal',
  [STATUS_CODE.LOCK_CONFLICT]: 'Lock conflict',
  [STATUS_CODE.DIR_NOT_EMPTY]: 'Directory not empty',
  [STATUS_CODE.NOT_A_DIRECTORY]: 'Not a directory',
  [STATUS_CODE.INVALID_FILENAME]: 'Invalid filename',
  [STATUS_CODE.LINK_LOOP]: 'Link loop',
  [STATUS_CODE.CANNOT_DELETE]: 'Cannot delete',
  [STATUS_CODE.INVALID_PARAMETER]: 'Invalid parameter',
  [STATUS_CODE.FILE_IS_A_DIRECTORY]: 'File is a directory',
  [STATUS_CODE.BYTE_RANGE_LOCK_CONFLICT]: 'Byte range lock conflict',
  [STATUS_CODE.BYTE_RANGE_LOCK_REFUSED]: 'Byte range lock refused',
  [STATUS_CODE.DELETE_PENDING]: 'Delete pending',
  [STATUS_CODE.FILE_CORRUPT]: 'File corrupt',
  [STATUS_CODE.OWNER_INVALID]: 'Owner invalid',
  [STATUS_CODE.GROUP_INVALID]: 'Group invalid',
  [STATUS_CODE.NO_MATCHING_BYTE_RANGE_LOCK]: 'No matching byte range lock',
};
