...
var Connection = function(opts) {
  ...
  this._parser.on('USERAUTH_FAILURE', function(auths, partial) {
    ...
    // TODO: automatically try 'keyboard-interactive' if user wants
  ...
  this._parser.on('CHANNEL_OPEN', function(channel) {
  });
...
Connection.prototype.connect = function(opts) {
  ...
  this._tryKeyboard = opts.tryKeyboardAuth;
...
Connection.prototype._authPK = function() {
