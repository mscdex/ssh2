...
function Server(cfg, listener) {
  ...
  this._srv = new net.Server(function(socket) {
    ...
    // since joyent/node#993bb93e0a, we have to "read past EOF" in order to get
    // an `end` event on streams. thankfully adding this does not negatively
    // affect node versions pre-joyent/node#993bb93e0a.
